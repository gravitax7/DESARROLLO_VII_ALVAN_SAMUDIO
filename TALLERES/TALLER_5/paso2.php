...
// Tu código aquí
PrecioMasAlto($inventario);
function PrecioMasAlto($inventario) {
$valormayor=0;
$totalactual2=0;
$product="";
foreach($inventario as $inv=> $info) {
$totalactual2 = $info["cantidad"] * $info["precio"];
//echo $totalactual2;
//echo "<br>";
if ($totalactual2 > $valormayor){
    $valormayor=$totalactual2;
    $product= $inv;
