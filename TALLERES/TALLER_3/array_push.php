...
$misAmigos = ["Erika","Annie","Jorge"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Diocenio", "Jose"); // Reemplaza las comillas vacías con los nombres de tus amigos
