...
$misAmigos = ["Gilberto","Jorge Luis","Abraham"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Donald", "Lisseth"); // Reemplaza las comillas vacías con los nombres de tus amigos
