...
$miArray = ["Cilindros","Cárter","Clutch","Ejes"]; // Reemplaza esto con tu propio array
$miString = "Cambio de aceite cada 12000 kilómetros"; // Reemplaza esto con tu propio string
$miNumero = 107; // Reemplaza esto con tu propio número
