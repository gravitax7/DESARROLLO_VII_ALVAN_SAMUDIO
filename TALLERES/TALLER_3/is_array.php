...
$miArray = ["Objeto 1","OBjeto2","Objeto 77"]; // Reemplaza esto con tu propio array
$miString = "Ya es septiembre, se siente la navidad"; // Reemplaza esto con tu propio string
