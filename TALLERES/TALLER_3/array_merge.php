...
$misComidas = ["Arroz con chili", "Ensalada de papa con pollo guisado", "Arroz frito combinación"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Salchipapa", "Arepas con queso nica", "Ensalada de mango"]; // Reemplaza con las comidas favoritas de tu amigo
