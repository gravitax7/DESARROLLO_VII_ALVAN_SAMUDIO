...
$misComidas = ["Arroz con pollo", "saus", "Patacones con salchichas"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Molleja", "Salami", "Pollo"]; // Reemplaza con las comidas favoritas de tu amigo
