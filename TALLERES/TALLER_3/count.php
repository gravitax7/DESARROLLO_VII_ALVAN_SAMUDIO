...
$misCanciones = ["Dont Stop", "Californication","Pongan bachata","Surrender"]; // Reemplaza esto con tu array de canciones
...
$totalplaylist= count($playlist);
echo"<br>Número de canciones en mi array multidimensional: $totalplaylist</br>";
