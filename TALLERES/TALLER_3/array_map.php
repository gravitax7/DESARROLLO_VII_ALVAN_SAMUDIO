...
$nombres = ["Alberto", "Silvia", "Karen"];
$apellidos = ["Fuentes", "Acevedo", "Troya"];
...
$productosConDescuento = array_map(function($productos) {
    $productos['precio_descuento'] = $productos['precio'] * 0.9; // 10% de descuento      
    return $productos;
}, $producto);
