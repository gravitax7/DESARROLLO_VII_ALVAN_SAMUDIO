...
$texto = "Mundial Qatar 2022";
$extracto1 = substr($texto, 1, 4);  // Extrae desde la posición 0, 4 caracteres
$extracto2 = substr($texto, 3);     // Extrae desde la posición 5 hasta el final
